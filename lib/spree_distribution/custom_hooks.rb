...
#insert_before :account_my_orders,         'hooks/distribution_customer'
Deface::Override.new(:virtual_path => 'users/show',
:name => 'distribution-my-orders',
:insert_before => "[data-hook='account_my_orders'], #account_my_orders[data-hook]",
:partial => "hooks/distribution_customer",
:disabled => false)

#insert_before :inside_cart_form,          'hooks/distribution_customer_id'
...
:partial => "hooks/distribution_customer_id",
:disabled => false)

#insert_before :checkout_payment_step,     'hooks/distribution_payment_options'
...
:partial => "hooks/distribution_payment_options",
:disabled => false)


#insert_after  :admin_order_show_buttons,  'hooks/distribution_customer_id'
...
# insert_after :admin_tabs,                 'admin/hooks/distribution_tab'
...
:name => "admin-distribution-tab-ul",
:insert_bottom => "div#admin-menu ul",
:partial => "admin/hooks/distribution_tab",
:disabled => false)
